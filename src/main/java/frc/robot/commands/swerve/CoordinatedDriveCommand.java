...
public class CoordinatedDriveCommand extends CommandBase {
     ...
     */
    public CoordinatedDriveCommand(Launcher mLauncher, DoubleSupplier translationAxis, DoubleSupplier strafeAxis,
            DoubleSupplier scaleAxis, DoubleSupplier rotationAxis, boolean fieldRelative) {

        this.mLauncher = mLauncher;
        addRequirements(mLauncher, SJTUSwerveMK5Drivebase.getInstance(), TurretSubsystem.getInstance());
    ...
    public void execute() {
        ...
        mLauncher.driveCoordinated(translation, rotation, fieldRelative);
    }
