...
public class Lights {
    ...
    public static final LEDState IP_BLUE = new LEDState(97 / 255.0, 196 / 255.0, 227 / 255.0);
    ...
    public static final BlinkingLEDState CALIBRATION = new BlinkingLEDState(ORANGE, OFF, 1.0);
    ...
    public static final BlinkingLEDState READY = new BlinkingLEDState(GREEN, OFF, 1.0);
    public static final BlinkingLEDState CLIMBING = new BlinkingLEDState(IP_BLUE, OFF, 1.0);
}
