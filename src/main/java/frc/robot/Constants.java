...
public final class Constants {
    ...
    public static final double DRIVETRAIN_HEADING_CONTROLLER_KI = 0.00001;
    ...
    // Intaker Constants
    public static final double INTAKER_FAST_INTAKE_PERCENTAGE = 0.5;
    ...
    public static final double TRIGGER_KP_V_SLOT_1 = 0.1;
    public static final double TRIGGER_KI_V_SLOT_1 = 0.0005;
    ...
    public static final double HOOD_MAXIMUM_ANGLE = 70.0;
    ...
    public static final double HOOD_HOMING_CURRENT_THRESHOLD = 10.0;

    // Turret Constants
    public static final double TURRET_GEAR_RATIO = 7.0 * 181.0 / 18.0;
    public static final double TURRET_SAFE_ZONE_DEGREE = 100.0;
    public static final double TURRET_MAX_ROTATION_DEGREE = 110.0;
    ...
    public static final double TURRET_MANUAL_ROTATION_GAP_ZONE = 10.0;
    ...
    public static final double TURRET_KF = 1024.0 / (72078.22222 / 2.0) * 1.1;
