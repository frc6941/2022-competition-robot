...
public final class Constants {
    ...
    public static final double TURRET_SAFE_ZONE_DEGREE = 90.0;
    public static final double TURRET_MAX_ROTATION_DEGREE = 95.0;
    ...
    public static final double TURRET_KI = 0.000025;
        ...
        public static final class Turret {
            public static final LimelightConstants LIMELIGHT_CONSTANTS = new LimelightConstants();
                static{
                    ...
                    LIMELIGHT_CONSTANTS.kHeight = new TunableNumber("Turret Limelight Height", 0.83);
                    LIMELIGHT_CONSTANTS.kHorizontalPlaneToLens = new TunableNumber("Turret Limelight Horizontal Plane to Lens", 50.0);
                    LIMELIGHT_CONSTANTS.kTurretToLens = new Pose2d(0.06, 0.0, new com.team254.lib.geometry.Rotation2d());
                }
