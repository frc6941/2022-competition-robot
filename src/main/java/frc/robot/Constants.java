...
public final class Constants {
    ...
    public static final double kLooperDt = 1.0 / 200.0; // The robot is running at 150Hz
    ...
    public static final double FEEDER_FEED_REVERSE_PERCENTAGE = -0.60;
    ...
    public static final double BALLPATH_SLOW_PROCESS_TIME = 1.0;
