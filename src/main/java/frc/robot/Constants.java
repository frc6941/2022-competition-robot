...
public final class Constants {
    ...
    public static final double TRIGGER_SLOW_EJECT_VELOCITY = 0.3;
    public static final double TRIGGER_FEEDING_VELOCITY = 0.8;
    public static final double TRIGGER_REVERSING_VELOCITY = -0.4;
    ...
    public static final double TRIGGER_KP_V_SLOT_1 = 0.2;
