...
public class DFiveAuto extends AutoModeBase{
    ...
    private final PathPlannerTrajectory trajectoryPart1 = PathPlanner.loadPath("D 5 Ball Auto - Part 1", 3.2, 3.0);
    private final PathPlannerTrajectory trajectoryPart2 = PathPlanner.loadPath("D 5 Ball Auto - Part 2", 3.2, 3.2);
    private final PathPlannerTrajectory trajectoryPart3 = PathPlanner.loadPath("D 5 Ball Auto - Part 3", 3.2, 3.2);
    private final PathPlannerTrajectory trajectoryPart4 = PathPlanner.loadPath("D 5 Ball Auto - Part 4", 3.2, 3.0);
