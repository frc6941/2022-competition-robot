...
public final class SimpleTestTrajectories {
        ...
        public static final Trajectory GoLeftSideway = TrajectoryGenerator.generateTrajectory(
                        ...
                        new Pose2d(3, -1, Rotation2d.fromDegrees(0.0)),
                        Constants.AutoConstants.TRAJECTORY_CONFIG);

        public static final PathPlannerTrajectory ComplexAutonomousRoutine = PathPlanner.loadPath(
                        "Autonomous Test Trajectory",
                        Constants.AutoConstants.TRAJECTORY_SAFE_MODE_CONFIG.getMaxVelocity(),
                        Constants.AutoConstants.TRAJECTORY_SAFE_MODE_CONFIG.getMaxAcceleration());
}
