...
// It's just a direct copy of {@link SmartDashboard}. Making all the PulseHUD related data to appear in the correct root.
...
/**
 * The {@link PulseHUD} class is the bridge between robot programs and the
 * SmartDashboard on
 * the laptop.
 *
 * <p>
 * When a value is put into the SmartDashboard here, it pops up on the
 * SmartDashboard on the
 * laptop. Users can put values into and get values from the SmartDashboard.
 */
public final class PulseHUD {
    /** The {@link NetworkTable} used by {@link PulseHUD}. */
    private static final NetworkTable table = NetworkTableInstance.getDefault().getTable("PulseHUD");
    ...
    /**
     * The executor for listener tasks; calls listener tasks synchronously from main
     * thread.
     */
     ...
     * be null. The value
     * can be retrieved by calling the get method with a key that is equal to the
     * original key.
     *
     * @param key  the key
