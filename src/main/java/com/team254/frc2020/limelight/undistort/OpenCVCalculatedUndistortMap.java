...
public class OpenCVCalculatedUndistortMap implements UndistortMap {
     ...
     */
    private static double[] undistortFromOpenCV(CameraConstants undistortConstants, double[] point) {
        ...
        Calib3d.undistortPoints(new MatOfPoint2f(coord), new MatOfPoint2f(dst), camMtx, distortion, new Mat(), camMtx);
