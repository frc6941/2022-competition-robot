    ...
    public static class TrackReportComparator implements Comparator<TrackReport> {
        ...
        double score(TrackReport report) {
            ...
            double age_score = mAgeWeight
                    * Math.max(0, (frc.robot.Constants.VisionConstants.Turret.MAX_GOAL_TRACK_AGE - (mCurrentTimestamp - report.latest_timestamp))
                    / frc.robot.Constants.VisionConstants.Turret.MAX_GOAL_TRACK_AGE);
